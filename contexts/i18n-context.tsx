...
const resources = {
  "zh-TW": {
    translation: {
      ...
      // Wishlist
      "wishlist.title": "願望清單",
      "wishlist.empty": "願望清單是空的",
      "wishlist.emptyMessage": "您的願望清單中沒有商品",
      "wishlist.startShopping": "開始購物",
      "wishlist.addToCart": "加入購物車",
      "wishlist.viewDetails": "查看詳情",
      "wishlist.addToCompare": "加入比較",
      "wishlist.clearWishlist": "清空願望清單",
      "wishlist.viewCompare": "查看比較",
      
      // Compare
      "compare.title": "商品比較",
      "compare.empty": "比較清單是空的",
      "compare.emptyMessage": "從願望清單或產品頁面添加商品進行比較",
      "compare.viewProducts": "查看產品",
      "compare.viewWishlist": "查看願望清單",
  ...
  vi: {
    translation: {
      ...
      "profile.memberLevel": "Cấp độ thành viên",
      ...
      "wishlist.viewDetails": "Xem chi tiết",
  ...
  th: {
    translation: {
      ...
      "profile.memberLevel": "ระดับสมาชิก",
      
      // Cart
      "cart.title": "ตะกร้าสินค้า",
      "cart.empty": "ตะกร้าว่างเปล่า",
      "cart.emptyMessage": "ยังไม่มีสินค้าในตะกร้า",
      ...
      "cart.shippingInfo": "• จัดส่งฟรีสำหรับคำสั่งซื้อตั้งแต่ $1,000",
      "cart.deliveryInfo": "• จัดส่งภายใน 2-3 วันทำการ",
      "cart.returnInfo": "• รับคืนภายใน 7 วันโดยไม่มีเงื่อนไข",
      
      // Wishlist
      "wishlist.title": "รายการโปรด",
      "wishlist.empty": "รายการโปรดว่างเปล่า",
      "wishlist.emptyMessage": "ยังไม่มีสินค้าในรายการโปรด",
      "wishlist.startShopping": "เริ่มช้อปปิ้ง",
      "wishlist.addToCart": "เพิ่มลงตะกร้า",
      "wishlist.viewDetails": "ดูรายละเอียด",
      ...
      "compare.clearCompare": "ล้างการเปรียบเทียบ",
  ...
  hi: {
    translation: {
      ...
      "profile.memberLevel": "सदस्यता स्तर",
  ...
  en: {
    translation: {
      ...
      "profile.memberLevel": "Membership Level",
      ...
      "compare.clearCompare": "Clear Comparison",
